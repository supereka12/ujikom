...
<div class="h-screen bg-gray-200 dark:bg-gray-800 flex items-start justify-center pt-6 px-4 md:px-4 lg:px-6">
    <div class="container max-w-6xl bg-white shadow-lg transform duration-200 ease-in-out">
        ...
        <div class="flex px-6 -mt-14 items-center">
            <img class="h-48 w-48 bg-white p-2 rounded-full" src="{{ asset('profile.jpg') }}" alt="Profile Image" />
